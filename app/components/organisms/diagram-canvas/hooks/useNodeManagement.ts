...
export function useNodeManagement() {
            ...
            connectedConnections.forEach((conn) => {
              ...
              if (connIndex >= 0) {
                ...
                if (conn.sourceId === nodeId) {
                  ...
                  updatedConn.sourceX = calculateConnectionPoint(
                    updatedNode!,
                    conn.sourcePosition
                  ).x;
                  updatedConn.sourceY = calculateConnectionPoint(
                    updatedNode!,
                    conn.sourcePosition
                  ).y;
                }
                ...
                if (conn.targetId === nodeId) {
                  ...
                  updatedConn.targetX = calculateConnectionPoint(
                    updatedNode!,
                    conn.targetPosition
                  ).x;
                  updatedConn.targetY = calculateConnectionPoint(
                    updatedNode!,
                    conn.targetPosition
                  ).y;
                }
  ...
  const updateNodeProperties = useCallback((nodeId: string, properties: Partial<NodeType>) => {
    setNodes((prevNodes) => {
