...
export const CanvasToolbar: React.FC<CanvasToolbarProps> = ({
  ...
  return (
    <div className="canvas-toolbar-container canvas-toolbar-scroll-indicator mb-2 block overflow-x-auto xl:hidden">
      <div className="canvas-toolbar-inner flex min-w-fit items-center gap-2 rounded-lg border bg-white p-2 shadow-sm">
