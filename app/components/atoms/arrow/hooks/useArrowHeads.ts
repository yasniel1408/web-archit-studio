...
export const useArrowHeads = ({
  ...
  const arrowHeadPaths = useMemo(() => {
    const startPath = startArrowHead !== 'none' ? 
                     calculateArrowHeadPath(startPosition, startX, startY, true, startArrowHead) : 
                     null;
                     
    const endPath = endArrowHead !== 'none' ? 
                    calculateArrowHeadPath(endPosition, endX, endY, false, endArrowHead) : 
                    null;
