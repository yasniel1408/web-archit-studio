...
export const modalContainerStyles = 'bg-white rounded-lg shadow-xl overflow-hidden max-h-[90vh] flex flex-col';
...
export const modalStyles = {
  ...
  closeButton: 'text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center',
