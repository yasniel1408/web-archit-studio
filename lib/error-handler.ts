...
export class ErrorHandler {
  ...
  static logError(error: Error, context?: Record<string, any>, severity: AppError['severity'] = 'medium'): AppError {
...
export const createError = (message: string, code: string, context?: Record<string, any>) => {
